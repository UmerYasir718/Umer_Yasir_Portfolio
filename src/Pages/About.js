        ...
        <Row>
          <Col md={12}>
            ...
            <div className="introduction-line my-3">
              𝐈'𝐦 𝐚 𝐬𝐤𝐢𝐥𝐥𝐞𝐝 𝐬𝐨𝐟𝐭𝐰𝐚𝐫𝐞 𝐝𝐞𝐯𝐞𝐥𝐨𝐩𝐞𝐫 𝐰𝐢𝐭𝐡 𝐞𝐱𝐩𝐞𝐫𝐢𝐞𝐧𝐜𝐞 𝐢𝐧 𝐓𝐲𝐩𝐞𝐒𝐜𝐫𝐢𝐩𝐭 𝐚𝐧𝐝
              𝐚𝐯𝐚𝐒𝐜𝐫𝐢𝐩𝐭, 𝐚𝐧𝐝 𝐞𝐱𝐩𝐞𝐫𝐭 𝐢𝐬𝐞 𝐢𝐧 𝐟𝐫𝐚𝐦𝐞𝐰𝐨𝐫𝐤𝐬 𝐥𝐢𝐤𝐞 𝐑𝐞𝐚𝐜𝐭, 𝐍𝐨𝐝𝐞.𝐣𝐬, 𝐚𝐧𝐝
              𝐓𝐡𝐫𝐞𝐞.𝐣𝐬. 𝐈'𝐦 𝐚 𝐪𝐮𝐢𝐜𝐤 𝐥𝐞𝐚𝐫𝐧𝐞𝐫 𝐚𝐧𝐝 𝐜𝐨𝐥𝐥𝐚𝐛𝐨𝐫𝐚𝐭𝐞 𝐜𝐥𝐨𝐬𝐞𝐥𝐲 𝐰𝐢𝐭𝐡 𝐜𝐥𝐢𝐞𝐧𝐭𝐬
              𝐭𝐨 𝐜𝐫𝐞𝐚𝐭𝐞 𝐞𝐟𝐟𝐢𝐜𝐢𝐞𝐧𝐭, 𝐬𝐜𝐚𝐥𝐚𝐛𝐥𝐞, 𝐚𝐧𝐝 𝐮𝐬𝐞𝐫-𝐟𝐫𝐢𝐞𝐧𝐝𝐥𝐲 𝐬𝐨𝐥𝐮𝐭𝐢𝐨𝐧𝐬 𝐭𝐡𝐚𝐭
              𝐬𝐨𝐥𝐯𝐞 𝐫𝐞𝐚𝐥-𝐰𝐨𝐫𝐥𝐝 𝐩𝐫𝐨𝐛𝐥𝐞𝐦𝐬. 𝐋𝐞𝐭'𝐬 𝐰𝐨𝐫𝐤 𝐭𝐨𝐠𝐞𝐭𝐡𝐞𝐫 𝐭𝐨 𝐛𝐫𝐢𝐧𝐠 𝐲𝐨𝐮𝐫 𝐢𝐝𝐞𝐚𝐬
              𝐭𝐨 𝐥𝐢𝐟𝐞!
              ...
              {/* 𝐈'𝐦 𝐚 𝐬𝐤𝐢𝐥𝐥𝐞𝐝 𝐬𝐨𝐟𝐭𝐰𝐚𝐫𝐞 𝐝𝐞𝐯𝐞𝐥𝐨𝐩𝐞𝐫 𝐰𝐢𝐭𝐡 𝐞𝐱𝐩𝐞𝐫𝐢𝐞𝐧𝐜𝐞 𝐢𝐧 𝐓𝐲𝐩𝐞𝐒𝐜𝐫𝐢𝐩𝐭 𝐚𝐧𝐝
              𝐉𝐚𝐯𝐚𝐒𝐜𝐫𝐢𝐩𝐭, 𝐚𝐧𝐝 𝐞𝐱𝐩𝐞𝐫𝐭 𝐢𝐬𝐞 𝐢𝐧 𝐟𝐫𝐚𝐦𝐞𝐰𝐨𝐫𝐤𝐬 𝐥𝐢𝐤𝐞 𝐑𝐞𝐚𝐜𝐭, 𝐍𝐨𝐝𝐞.𝐣𝐬, 𝐚𝐧𝐝
              𝐓𝐡𝐫𝐞𝐞.𝐣𝐬. 𝐈'𝐦 𝐚 𝐪𝐮𝐢𝐜𝐤 𝐥𝐞𝐚𝐫𝐧𝐞𝐫 𝐚𝐧𝐝 𝐜𝐨𝐥𝐥𝐚𝐛𝐨𝐫𝐚𝐭𝐞 𝐜𝐥𝐨𝐬𝐞𝐥𝐲 𝐰𝐢𝐭𝐡 𝐜𝐥𝐢𝐞𝐧𝐭𝐬
              𝐭𝐨 𝐜𝐫𝐞𝐚𝐭𝐞 𝐞𝐟𝐟𝐢𝐜𝐢𝐞𝐧𝐭, 𝐬𝐜𝐚𝐥𝐚𝐛𝐥𝐞, 𝐚𝐧𝐝 𝐮𝐬𝐞𝐫-𝐟𝐫𝐢𝐞𝐧𝐝𝐥𝐲 𝐬𝐨𝐥𝐮𝐭𝐢𝐨𝐧𝐬 𝐭𝐡𝐚𝐭
              𝐬𝐨𝐥𝐯𝐞 𝐫𝐞𝐚𝐥-𝐰𝐨𝐫𝐥𝐝 𝐩𝐫𝐨𝐛𝐥𝐞𝐦𝐬. 𝐋𝐞𝐭'𝐬 𝐰𝐨𝐫𝐤 𝐭𝐨𝐠𝐞𝐭𝐡𝐞𝐫 𝐭𝐨 𝐛𝐫𝐢𝐧𝐠 𝐲𝐨𝐮𝐫 𝐢𝐝𝐞𝐚𝐬
              𝐭𝐨 𝐥𝐢𝐟𝐞! */}
              {/* I'm a skilled software developer with experience in
              TypeScript and JavaScript, and expert ise in frameworks like
